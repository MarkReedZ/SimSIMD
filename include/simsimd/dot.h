...
SIMSIMD_MAKE_DOT(serial, bf16, f32, SIMSIMD_IDENTIFY)          // simsimd_dot_bf16_serial
SIMSIMD_MAKE_COMPLEX_DOT(serial, bf16, f32, SIMSIMD_IDENTIFY)  // simsimd_dot_bf16c_serial
SIMSIMD_MAKE_COMPLEX_VDOT(serial, bf16, f32, SIMSIMD_IDENTIFY) // simsimd_vdot_bf16c_serial
...
SIMSIMD_MAKE_DOT(accurate, bf16, f64, SIMSIMD_IDENTIFY)          // simsimd_dot_bf16_accurate
SIMSIMD_MAKE_COMPLEX_DOT(accurate, bf16, f64, SIMSIMD_IDENTIFY)  // simsimd_dot_bf16c_accurate
SIMSIMD_MAKE_COMPLEX_VDOT(accurate, bf16, f64, SIMSIMD_IDENTIFY) // simsimd_vdot_bf16c_accurate
